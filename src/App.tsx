...
const projects: Project[] = [
  ...
  {
    id: 'fs-ihs-visitor',
    title: 'IHS — Visitor & Student Entry System',
    description:
      'MERN visitor + student entry management system with check-in/out tracking, QR/barcode scanning, admin logs, and dashboard analytics.',
    cta: 'View Details',
    tone: 'sky',
    kind: 'fullstack',
    liveUrl: 'https://github.com/00tatheer00/Institute-of-Health-Sciences-Visitor-Student-Management-System',
    repoUrl: 'https://github.com/00tatheer00/Institute-of-Health-Sciences-Visitor-Student-Management-System',
    client: 'Institute of Health Sciences',
    role: 'Full Stack Developer',
    timeline: 'Production-ready build',
    stack: ['Web App', 'REST API', 'Admin Dashboard', 'Scanner', 'Reports', 'Analytics'],
    tech: ['React 18 (Vite)', 'Node.js', 'Express', 'MongoDB', 'Recharts'],
    highlights: [
      'Visitor check-in with CNIC, purpose, person to meet; check-out tracking',
      'Active visitors table with auto-refresh',
      'Student entry via QR/barcode scanning (USB scanner or laptop camera)',
      'Admin: visitor logs, student registration, bulk import, reports, CSV export',
  ...
  {
    id: 'fs-tatheerapp-chat',
    title: 'TatheerApp — Real‑Time Chat (WebSocket + WebRTC)',
    description:
      'WhatsApp-like real-time chat app with Socket.io messaging, OTP auth, and 1:1 voice/video calls using WebRTC.',
    cta: 'View Details',
    tone: 'sky',
    kind: 'fullstack',
    liveUrl: 'https://chat-application-one-bice.vercel.app',
    repoUrl: 'https://github.com/00tatheer00/Chat-Application',
    client: 'Personal project',
    role: 'Full Stack Developer',
    timeline: 'Production-ready build',
    stack: ['Web App', 'Realtime', 'Auth', 'Calls', 'API', 'Database'],
    tech: ['React 18 (Vite)', 'Express', 'Socket.io', 'MongoDB (Mongoose)', 'WebRTC', 'EmailJS (OTP)'],
    highlights: [
      'Chat list + conversation screens with desktop split view and mobile navigation',
      'Real-time messaging with typing indicators, reactions, replies, read receipts',
      'Edit/delete your own messages + emoji picker',
      'Direct messages and group chats',
      'Email registration with OTP verification (EmailJS)',
      '1:1 voice and video calls (WebRTC)',
    ],
  },
  {
    id: 'fs-installment-ms',
    title: 'Installment Management System',
    description:
      'PHP-based system to manage customers, installment schedules, payments, and outstanding balances with automated status updates.',
    cta: 'View Details',
    tone: 'green',
    kind: 'fullstack',
    liveUrl: 'https://github.com/00tatheer00/Installment-Management-System',
    repoUrl: 'https://github.com/00tatheer00/Installment-Management-System',
    client: 'Small business workflow',
    role: 'Full Stack Developer',
    timeline: 'Production-ready build',
    stack: ['Web App', 'CRUD', 'Payments', 'Dashboard', 'Database'],
    tech: ['PHP', 'MySQL', 'HTML', 'CSS', 'JavaScript', 'XAMPP'],
    highlights: [
      'Customer management (create/update records)',
      'Installment scheduling with amounts and due dates',
      'Payment tracking with overdue monitoring',
      'Automated installment status updates based on payment activity',
      'Dashboard overview for pending payments and recent activity',
      'Full CRUD across customers, plans, and payments',
    ],
  },
  {
    id: 'fs-booking',
  ...
  {
    id: 'fe-emergingedge',
    title: 'EmergingEdge — Landing Page',
    description:
      'Landing page for Emerging Edge: a forward-thinking software development company focused on MERN apps, AI integrations, and scalable solutions.',
    cta: 'View Details',
    tone: 'indigo',
    kind: 'frontend',
    liveUrl: 'https://github.com/00tatheer00/EmergingEdge-LandingPage',
    repoUrl: 'https://github.com/00tatheer00/EmergingEdge-LandingPage',
    client: 'Emerging Edge',
    role: 'Frontend Developer',
    timeline: 'Landing page',
    stack: ['Landing page', 'Responsive UI'],
    tech: ['HTML', 'CSS', 'JavaScript'],
    highlights: ['Responsive layout', 'Clean marketing sections', 'Production-ready static site'],
  },
  {
    id: 'fe-tech4edges-site',
    title: 'Tech4Edges — Official Company Website',
    description:
      'Official website for Tech4Edges, showcasing brand story, services, technology stack, and a modern company presence.',
    cta: 'View Details',
    tone: 'green',
    kind: 'frontend',
    liveUrl: 'https://tech4edges.com',
    repoUrl: 'https://github.com/00tatheer00/Tech4Edges-Official-Site',
    client: 'Tech4Edges',
    role: 'Frontend Developer',
    timeline: 'Company site',
    stack: ['Marketing site', 'Pages', 'Components'],
    tech: ['React (Vite)', 'JavaScript', 'CSS'],
    highlights: ['Services pages', 'Brand/marketing content', 'Modern UI/UX layout', 'Fast Vite-based build'],
  },
  {
    id: 'fe-south-africa-construction',
    title: 'South Africa Construction — Company Website',
    description:
      'Professional construction company website highlighting services, project portfolio, safety standards, and client-focused solutions.',
    cta: 'View Details',
    tone: 'teal',
    kind: 'frontend',
    liveUrl: 'https://github.com/00tatheer00/South-Africa-Construction-Project',
    repoUrl: 'https://github.com/00tatheer00/South-Africa-Construction-Project',
    client: 'Construction company (South Africa)',
    role: 'Frontend Developer',
    timeline: 'Website build',
    stack: ['Multi-page site', 'Portfolio', 'Contact'],
    tech: ['HTML', 'CSS', 'SCSS/Sass', 'JavaScript'],
    highlights: ['Services pages', 'Project portfolio pages', 'Professional UI for business', 'Responsive layout'],
  },
  {
    id: 'fe-mobile-ui',
